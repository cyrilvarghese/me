...
export default function FrontScale() {
  return (
    <svg {...svgProps}>
      <rect x="150" y="577" width="410" height="106" rx="53" fill="#1c1c1b" stroke={EDGE_WHITE} strokeWidth="1.5" />
      ...
      {/* rear decorative pin */}
      <circle cx="205" cy="630" r="10" fill="#0f0f0f" stroke={EDGE_WHITE} strokeWidth="2" />
      {/* hinge pin — the shared pivot at (505, 630) */}
      <circle cx="505" cy="630" r="14" fill="#0f0f0f" stroke={RED} strokeWidth="3" />
