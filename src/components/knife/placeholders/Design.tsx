...
export default function Design() {
  return (
    <svg {...svgProps}>
      ...
      <path d="M262 638 L190 638" stroke="#151111" strokeWidth="3" />
      <circle cx="232" cy="638" r="5" fill="#151111" />
      <polygon data-tip="" points="178,634.5 160,638 178,641.5" fill={RED} />
      <circle cx="500" cy="638" r="11" fill="#130f0f" stroke={SCREW} strokeWidth="3" />
