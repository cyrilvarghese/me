 ...
 * signal red, with the same center pin as the knife's hinge. The needle
 * group carries [data-needle] so the transition timeline can swing it.
 */
export default function CompassRose() {
  ...
  return (
    <svg {...svgProps}>
      ...
      {/* center pin — same element as the knife hinge */}
